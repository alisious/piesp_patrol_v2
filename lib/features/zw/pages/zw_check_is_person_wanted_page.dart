// lib/features/zw/pages/zw_check_is_person_wanted_page.dart
...
class ZwCheckIsPersonWantedPage extends StatefulWidget {
  const ZwCheckIsPersonWantedPage({super.key});

  @override
  State<ZwCheckIsPersonWantedPage> createState() => _ZwCheckIsPersonWantedPageState();
}

class _ZwCheckIsPersonWantedPageState extends State<ZwCheckIsPersonWantedPage> {
  ...
  /// Wyświetla dialog z wynikiem sprawdzenia. Tło wg koloru, czcionka standardowa. Zamyka się po kliknięciu Zamknij.
  ...
  Future<void> _onSearch() async {
    ...
    try {
      ...
      if (result.isOk) {
        ...
        if (isWanted) {
          _showResultDialog(
            'Osoba o podanym numerze PESEL figuruje w rejestrze jako poszukiwana.',
            backgroundColor: Colors.red,
          );
        } else {
          _showResultDialog(
            'Brak wpisów o poszukiwaniu dla podanego numeru PESEL.',
            backgroundColor: Colors.green,
          );
        }
      } else {
        final msg = result.error.message.isNotEmpty
